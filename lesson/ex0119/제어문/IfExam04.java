class IfExam04{
	public static void main(String [] args){
		...
		// 1~12사이의 난수를 발생해서 발생한 난수의 해당하는 그달의 마지막 일수를 구한다.
		// 28일까지 입니다.(2)  30일까지 입니다.(4,6,9,11), 31일까지 입니다.(1,3,5,7,8,10,12)
		...
		default: System.out.println(month + "월은 31일까지 입니다."); break;
		}//swith문 끝

    
		System.out.println("---------위의 문제를 if문으로 변경------------------------");
