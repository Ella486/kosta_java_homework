class VariableTest {
	public static void main(String[] args) {
		...
		System.out.println("t.a = " + t.a);// Test의 전연변수를 나타냄으로 값이 0
...
class Test{
	...
	public void aa(){
		/*public*/ int a = 10; //지역변수( 지역변수 앞에는 제한자 올 수 없다) , 지역변수는 사용전에 반드시 초기화
		String addr = "서울";
		...
		//System.out.println("this.addr: " + this.addr); // 지역변수 앞에 this 사용불가.
