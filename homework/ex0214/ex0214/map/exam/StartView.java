...
public class StartView {
	...
	public static void main(String[] args) {
		...
		MapStudentController.inset(new Person("bbb", "시스타", 20));
		
		System.out.println("3.등록하기(Student) ******************");
		MapStudentController.inset(new Student("ccc", "빅뱅", 25, 80, 80, 80));
		
		System.out.println("3.등록하기(id 중복= key 중복) ******************");
		MapStudentController.inset(new Person("jang", "이쁜이", 30));
