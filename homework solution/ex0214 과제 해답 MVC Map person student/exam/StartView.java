...
public class StartView {
	...
	///////////////////////////////////////////////////////////////////
		...
		MapStudentController.update(new Person("jang", "이쁘이"));// id와 name만 전달- 생성자추가 --정상적으로 수정
		System.out.println();
		...
		// -> 실제 map에 저장된 jang은 Person타입 ,근데
				// 수정하려고 Student 넣으면 안된다.
				
		/*System.out.println("4.수정하기(Student) ******************");
		MapStudentController.update(new Student("jang", "얼짱", 40, 50, 50)); // -생성자 추가 - 오류 타일불일치
		System.out.println();
		...
		MapStudentController.update(new Student("king","왕자" , 40,50,50)); //-생성자 추가  -정상
		MapStudentController.selectAll();
